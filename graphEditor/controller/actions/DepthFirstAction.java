 ...
 */
public class DepthFirstAction extends AbstractAction implements Observer {

    private final GraphEditor editor;

    public DepthFirstAction(GraphEditor draw) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        editor.getSearch().depthFirst(inputValue);
